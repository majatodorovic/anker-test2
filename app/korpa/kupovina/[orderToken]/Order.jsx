...
const Order = ({ orderToken, className }) => {
  ...
  return (
    <div className="sectionPaddingX sectionPaddingY bg-white">
      {renderContent()}
    </div>
  );
};
    ...
    <>
      ...
      <div className={`mt-20 grid grid-cols-2 gap-16 xl:grid-cols-3`}>
          ...
          >
            {items?.map(
              ({
                ...
                return (
                  <div key={id} className={`col-span-1 border`}>
                    <Link href={`/${slug}`}>
                      <Image
                    ...
                    <div className="bg-secondary py-2">
                      <h2
                        className={`${className} text-center text-base font-light`}
                      >
                        {+quantity}x {name}
                      </h2>
                      <p
        ...
        <div className={`col-span-2 xl:col-span-1`}>
          ...
          <div className={`mt-10 flex flex-col gap-2 bg-secondary p-2`}>
          ...
          <div className={`mt-5 flex flex-col gap-2 bg-secondary p-2`}>
            <h3 className={`${className} text-base font-light`}>
              Prodavac:{" "}
              <span className={`font-normal`}>{process.env.NAME}</span>
            </h3>
            <h3 className={`${className} text-base font-light`}>
            ...
            <h3 className={`${className} text-base font-light`}>
              Adresa:{" "}
              <span className={`font-normal`}>{process.env.ADDRESS}</span>
            </h3>
          </div>
        </div>
      </div>
