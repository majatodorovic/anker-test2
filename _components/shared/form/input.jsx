...
export const FileUploadInput = ({
  ...
  return (
    <div className={`col-span-full mb-3 ${className ? className : ""}`}>
      <div className="bg-lightGray rounded-md border border-dashed border-gray-300 p-4">
        <label
          htmlFor={id}
...
export const CheckboxInput = ({
  ...
  return (
    <div
      className={`col-span-full my-auto mb-3 flex flex-col gap-0 ${
        className ? className : ""
      }`}
    >
      <div className={`flex flex-row-reverse items-center justify-end gap-2`}>
        <label htmlFor={id} className={`block text-base font-light`}>
          {placeholder}
          {required && <span className={`text-xs text-red-500`}> *</span>}
        </label>
        <input
